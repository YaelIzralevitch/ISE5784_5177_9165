...
public class LightsTests {
    ...
    public void sphereAllLights() {
        scene1.geometries.add(sphere);
        scene1.lights.add(new SpotLight(new Color(pink), new Point(20, 0, 50), new Vector(0, 0, -1)).setkL(0.0001).setkQ(0.000004));
        scene1.lights.add(new PointLight(new Color(yellow), new Point(100, 20, 5)).setkL(0.0001).setkQ(0.000002));
        scene1.lights.add(new DirectionalLight(new Color(orange), new Vector(1, -2, -1)));

        camera1.setImageWriter(new ImageWriter("lightSphereAllLights", 500, 500))
                .build()
                .renderImage()
                .writeToImage();
    }
    ...
    public void triangleAllLights() {
        Color color = new Color(300, 200, 550);
        scene2.geometries.add(triangle1, triangle2);
        scene2.lights.add(new SpotLight(color, new Point(-5,10,30), new Vector(-2,-5,-2))
                .setkL(0.001).setkQ(0.0001));
        scene2.lights.add(new PointLight(color, new Point(60,55,-125)).setkL(0.001).setkQ(0.0002));
        scene2.lights.add(new DirectionalLight(color, new Vector(-2,-5,-2)));


        camera2.setImageWriter(new ImageWriter("lightTriangleAllLights", 500, 500))
                .build()
                .renderImage()
                .writeToImage();
    }
