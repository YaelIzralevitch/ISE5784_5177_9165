...
class SphereTests {
    ...
    public void testFindIntersections() {
        ...
        final List<Point> result = sphere.findIntersections(new Ray(p01, v310)).stream()
        ...
        result = sphere.findIntersections(new Ray(p11, v11.scale(-1)));
        ...
        pOnTangent = new Point(1 + Math.sqrt(2), 0, 0);
        result = sphere.findIntersections(new Ray(pOnTangent, vOnTangent));
        assertEquals(null, result, "Ray crosses sphere");
