...
public class MiniProject1 {
    ...
    public void MP1() {
        ...
        camera.setImageWriter(new ImageWriter("MP1", 500, 500)) //
                .build() //
                .renderImage()
                .writeToImage();
...
*/
                ...
                new Sphere(10, new Point(0,80,-50))
        ...
        scene.lights.add(
                new SpotLight(new Color(1000, 600, 0), new Point(-161,72,-36), new Vector(161,-82,-14)) //
                        .setkL(0.0004).setkQ(0.0000006).setNarrowBeam(10));
        scene.lights.add(
                new PointLight(new Color(1000, 600, 0), new Point(0,80,-50))
